...
<%@page import="com.dvdrental.util.Util"%><html>
<head>
...
<div  class="formbox">
		...
		<div class="formboxcontent" align="center">
			<div id="login-error">
			<%
			if(Util.isLoggedIn(request)==false){ %>
	...
	<div align="center"><input type="image" src="<%=contextPath %>/images/user/login.png"  onClick="return validateLogin(this.form)" alt="Login"  />&nbsp;
	<input type="image" src="<%=contextPath %>/images/user/reset.png" alt="Reset" onClick="javascript:this.form.reset()"></div>	
</div>
<div class="formboxcontent">
	<div align="left"> 
	<ul>
		<li><a href="">Click here</a> to get help with your email and password.</li>
		<li><a href="<%=contextPath %>/jsp/user/registration/registration.jsp">Click here</a> to create a new account.</li>
