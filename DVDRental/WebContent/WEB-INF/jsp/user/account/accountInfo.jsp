...
<div  class="page">
	<%
	  ...
	  %>
	  Please <a href="<%=contextPath %>/jsp/user/login/login.jsp">Sign In</a> To See account Information.
	  <br>
	  Please <a href="<%=contextPath %>/jsp/user/registration/registration.jsp">Sign Up</a> If not a member.
	  <%}else{ %>
