...
<div style="width: 960px;" class="left-side">
...
<div style="margin:2px;">
	<div class="m-left-col">
		...
		<div class="m-blk-bg-txt"><%//Get movie Description from DB %>
		<object align="left" width="46%" height="255" style="margin-right: 5px;" classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95">
		<param value="images/rental/36_video.mpg" name="FileName">
		</object>
		</div> 
		</div>
	<span id="moviedetals">
